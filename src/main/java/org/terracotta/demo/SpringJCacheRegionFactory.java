 ...
 * @author Alex Snaps
 */
public class SpringJCacheRegionFactory implements RegionFactory {
                ...
                try {
                    ...
                    if ( cacheManagerUri != null ) {
                        ...
                        try {
                            ...
                            // ok well maybe the user wanted to give us a resource path relative to the root classpath
                            LOG.info("Attempting to a load a resource from root classpath, still using : " + uri.toString());
                            try {
                                uri = this.getClass().getResource("/" + cacheManagerUri).toURI();
